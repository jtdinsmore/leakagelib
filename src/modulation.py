...
def load_generic_modf_file(filename):
    ...
    interp1d(energies, modfs)


def get_mom(energies):
    ...
    load_generic_modf_file(f"{LEAKAGE_DATA_DIRECTORY}/modulation/mom.npy")(energies)
...
def get_nn(energies):
    ...
    load_generic_modf_file(f"{LEAKAGE_DATA_DIRECTORY}/modulation/nn.npy")(energies)