...
if __name__ == "__main__":
    ...
    parser.add_argument('--expmap', help="Chandra merged observation ARF")
    parser.add_argument("--output", help="Name of the output file")
    parser.add_argument("--width", help="Width of the image, in arcseconds. Default: as big as the CXO image")
    ...
    parser.add_argument("--reg-src", help="Source region. Should be saved in CIAO format with IXPE physical coordinates")
    parser.add_argument("--reg-bkg", help="Background region. Should be saved in CIAO format with IXPE physical coordinates")
