...
if __name__ == "__main__":
    ...
    parser.add_argument("--centerx", default=300, type=float, help="IXPE pixel on which the image will be centered in the x direction")
    parser.add_argument("--centery", default=300, type=float, help="IXPE pixel on which the image will be centered in the y direction")
