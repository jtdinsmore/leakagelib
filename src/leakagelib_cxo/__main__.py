...
if __name__ == "__main__":
    ...
    parser.add_argument("--centery", default=300, type=float, help="IXPE pixel on which the fit will be centered in the y direction. (Default: 300)")
    parser.add_argument("--reg-src", help="Source region. Should be saved in CIAO format in fk5 coordinates (Optional)")
    parser.add_argument("--reg-bkg", help="Background region. Should be saved in CIAO format in fk5 coordinates (Optional)")
