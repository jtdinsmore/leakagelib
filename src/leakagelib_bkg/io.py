...
def write_probs(infile, outfile, bg_probs):
    ...
    ----------
    infile : str
        Input file name which will be masked.
    outfile : str
        File to write the probabilities to. If the file already exists, it will be overwritten.
    mask : array-like of bool
        Boolean array created by `get_mask` to apply to the input file.
    """
