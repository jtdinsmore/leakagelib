...
def add_individual_background(settings, source):
    """
    Add background models to fit settings, with f, q, u per detector for both
    photon and particle backgrounds.

    Parameters
    ----------
    settings : fit_settings
        The fit_settings object to which background models will be added.
    """
...
def add_merged_backgrounds(settings, source, initial_values=None):
    """
    Add background models to fit settings using a specified background model.
    ...
    initial_values : dict, optional
        Initial values of the parameters. Defaults to zero for all unspecified parameters.
    """
